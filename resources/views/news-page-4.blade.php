...
<html xmlns:th="http://thymeleaf.org" lang="ru">
  <head>
    ...
    <title>
      41-я сессия Генеральной Конференции ЮНЕСКО открылась в Штаб-квартире
      Организации в Париже 9 ноября 2021 года и продолжится до 24 ноября.
    </title>
  </head>
  <body>
    ...
    <div class="news-page-main-container">
      ...
      <div class="news-page-paragraph">
        ...
        <a href="#" style="float: right">Узнать больше</a>
      </div>
    </div>
    <div class="panel"></div>
